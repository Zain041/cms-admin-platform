...
import { addNewService, deletePost, editPost } from "../../store/actions/actions";
...
class Service extends Component {
  ...
  handleSubmit = async (e) =>  {
    this.addPostToggle();
    e.preventDefault();
    await this.props.addNewService({
            ...
            <Card className="shadow">
                    <CardHeader className="border-0">
                     ...
                     <CardBody>
                         ...
                         <Input onChange={this.handlechange} name="service" className="r"  type="textarea" rows="4" />
